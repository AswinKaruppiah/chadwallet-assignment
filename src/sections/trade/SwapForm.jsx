...
export default function SwapForm({ activeToken, loading, solPrice, solPriceLoading, solPriceError, solBalance }) {
  ...
  return (
    <>
      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <button
          disabled
          className="w-full py-3 rounded-lg font-semibold text-sm bg-white/[0.04] text-white/25 cursor-not-allowed transition-colors"
        >
          Coming Soon
        </button>
      </div>
